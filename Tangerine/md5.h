...
//to call the function -----------CALL_MD5_Function(char *string)-----------
//my comipler is kep crashing but this code is right .
// if u want to acces the values use below code in main ...
// where arr stores the value
//char ** arr = nullptr;
//arr = CALL_MD5_Function("C:\\WINDOWS\\notepad.exe");
...
char * array_to_be_returned[100] = { '\0' };
